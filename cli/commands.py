# this was supposed to be functions for main.py to import
# but I ended up putting them directly in main.py 
# may fix later for better modularity, but for now this is fine since main.py is not too long :D


"""
# Each stage independently
python -m cli.main collect --source rss --days 7
...
python -m cli.main run-all --source nvd --days 14

# Keyword mode
python -m cli.main collect --source otx --query "ransomware"
"""
